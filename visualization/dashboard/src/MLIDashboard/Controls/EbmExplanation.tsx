        ...
        return coordinates.scores.map((scores, classIndex) => {
            ...
            return {
                ...
                error_y: {
                    type: 'data',
                    symmetric: false,
                    array: coordinates.upperBounds !== undefined ?
                        coordinates.upperBounds[classIndex].map((upperVal, index) => upperVal - scores[index]) : undefined,
                    arrayminus: coordinates.lowerBounds ?
                        coordinates.lowerBounds[classIndex].map((lowerVal, index) => scores[index] - lowerVal) : undefined
                }
            };
        });
    });
    ...
    = (memoize as any).default((featureIndex: number, explanationContext: IExplanationContext): IPlotlyProperty  => {
        ...
        return {
            ...
            layout: {
                ...
                yaxis: {
                    automargin: true,
                    title: (ebmObject.displayParameters && ebmObject.displayParameters.yAxisLabel) ? ebmObject.displayParameters.yAxisLabel : localization.IcePlot.predictedProbability
                },
                xaxis: {
                    title: featureName,
                    automargin: true
